...
type UserSettingsKey = typeof USER_SETTINGS_KEYS[keyof typeof USER_SETTINGS_KEYS];
...
export class SettingsService {
   ...
   */
  static async getSetting(key: UserSettingsKey, defaultValue: any = null) {
    try {
   ...
   */
  static async setSetting(key: UserSettingsKey, value: any) {
    try {
      // For now, use localStorage
   ...
   * @returns Success status
   */
  static async deleteSetting(key: UserSettingsKey) {
    try {
      // For now, use localStorage
   ...
   */
  static async syncWithCloud(settings: Record<string, any>) {
    try {
   ...
   * @param value - Setting value
   */
  static triggerSyncEvent(key: UserSettingsKey, value: any) {
    if (typeof window !== 'undefined') {
   ...
   */
  static onSyncEvent(callback: (detail: { key: UserSettingsKey; value: any; timestamp: string }) => void) {
    if (typeof window !== 'undefined') {
